...
export default function Index() {
    ...
    return (
        <div className = 'reactWrap' >
                ...
                <ul>
                    {
                        _.map(catalogue, (item, index) => {
                            return (
                            <Link to={index === 0 ? '/ReactStudy':`/ReactStudy/${item.routerName}/`}  style={{color: '#000', textDecoration: 'none'}} >    
            ...
            <div className='right'>
                <Router>
                    <Route exact path="/ReactStudy" component={Article1} />
                    <Route path="/ReactStudy/Article2" component={Article2} />
                    <Route path="/ReactStudy/Article3" component={Article3} />
                </Router>
            </div>
        </div>
    )
